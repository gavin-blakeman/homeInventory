...
#ifndef TBL_DOCUMENTS_H
#define TBL_DOCUMENTS_H
...
namespace database
{
  ...
  public:
    ...
    {
      Wt::Dbo::field(a, documentType, "DocumentType");
      Wt::Dbo::field(a, documentData, "DocumentData");
